...
import com.example.cup2.ui.UploadResumeActivity
...
class MockInterviewActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val resumeQuestionsCard = findViewById<MaterialCardView>(R.id.resumeQuestionsCard)
        resumeQuestionsCard.setOnClickListener {
